...
<div class="edit-wrap">
    ...
    <div class="page-subtitle">Perbarui informasi pelanggan rental mobil</div>
    ...
    <div class="edit-card">
        <div class="edit-card-header">
            ...
            <div>
                <div class="header-title">Form Edit Pelanggan</div>
                <div class="header-subtitle">Lengkapi data customer dengan informasi yang benar</div>
            </div>
        </div>
    ...
    @error('no_telp')<span class="invalid-feedback">{{ $message }}</span>@enderror
                ...
                <div class="field-wrap">
                    ...
                    <textarea name="alamat" rows="3"
                              ...
                              placeholder="Masukkan alamat domisili sekarang" required>{{ old('alamat', $customer->alamat) }}</textarea>
