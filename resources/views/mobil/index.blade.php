...
<style>
    ...
    .card-mobil:hover .img-mobil { transform: scale(1.12) rotate(2deg); }
    .status-badge {
    ...
    .mobil-name { font-size: 1.1rem; font-weight: 700; color: #1A2744; margin-bottom: 0.5rem; line-height: 1.3; }
    .mobil-price { font-size: 1.6rem; font-weight: 800; color: #d97706; margin-bottom: 1rem; }
    .mobil-price small { font-size: 0.7rem; color: #95a5a6; font-weight: 400; }
    .info-item {
    ...
    .info-item i { width: 20px; color: #1A2744; margin-right: 10px; }
    .info-item strong { color: #1A2744; }
    .action-buttons { margin-top: auto; padding-top: 1rem; display: flex; gap: 8px; }
    .btn-sewa {
        flex: 1;
    ...
    .btn-edit:hover {
        ...
        box-shadow: 0 8px 16px rgba(245, 158, 11, 0.4); color: #361c02;
    }
    .btn-delete {
        color: #141b28; font-size: 0.85rem;
        padding: 0.3rem 0.8rem; text-decoration: none !important;
    ...
    .stat-card h6 { font-size: 0.9rem; opacity: 0.8; margin-bottom: 0.5rem; color: #B8C8F0; }
    .stat-card .number { font-size: 2.2rem; font-weight: 800; color: white; }
    .stat-card.available { background: linear-gradient(135deg, #F59E0B 0%, #d97706 100%); }
    .stat-card.available h6 { color: #7C3E00; }
    .stat-card.available .number { color: #7C3E00; }
    .stat-card.unavailable { background: linear-gradient(135deg, #243460 0%, #1a3a6e 100%); }
    .header-section {
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
            <div class="card card-mobil shadow-sm bg-white">
                ...
                <div class="img-mobil-container position-relative">
                    ...
                    @php $isDisewa = $m->status === 'tidak tersedia'; @endphp
                ...
                <div class="card-body">
                    <h5 class="mobil-name" title="{{ $m->nama_mobil }}">{{ $m->nama_mobil }}</h5>
