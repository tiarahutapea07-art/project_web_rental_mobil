# Task: Integrasi Gambar Mobil dari Database
...
- [x] 7. Update View rental/create.blade.php (tampilkan foto mobil)
- [x] 8. Jalankan migration
- [x] 9. Buat seeder / update SQL agar nama mobil & nama foto sesuai file di public/img/
- [x] 10. Cleanup duplikat mobil & fix foto references (migration 3)
